    ...
    <div class="az-content">
      <div class="container">
        <div class="az-content-body">
          ...
          <div class="az-content-label mg-b-5">Jerarquía</div>
          <p class="mg-b-20">Información disponible</p>
...
var dataTable = $('#datatable1').DataTable({
  ...
  "bDeferRender": true,     
      ...
      "order":[],
    "ajax": {
    "url": "lib/server/fetchJerarquia.php",
    "type": "POST"
    },          
...
$('#add_button').click(function(){
  $('#jerarquia_form')[0].reset();
  $('.modal-title').text("Jerarquia");
  $('#action').val("Guardar Jerarquia");
  $('#operation').val("Guardar Jerarquia");
  $('#user_uploaded_image').html('');
  //$('.selectpicker').selectpicker();
 
 });
 $(document).on('submit', '#jerarquia_form', function(event){
  event.preventDefault();

  var detalleJerarquia= $('#detalleJerarquia').val();
 ...
 //  alert("Ingresa");
  $.ajax({
   url:"lib/server/fetchJerarquiaSingle.php",
   method:"POST",
   ...
   success:function(data)
   {
    ...
    $('#detalleJerarquia').val(data.detalleJerarquia);
 ...
 //   $('#mailInscripcion_alu').val(data.mailInscripcion_alu);
  //  $('#codigoIdentificacion_alu').val(data.codigoIdentificacion_alu);
   ...
   // $('#documentaciona_alu option[value='+data.documentaciona_alu+']').attr("selected",true);
    ...
    $('.modal-title').text("Editar Jerarquia");
    $('#user_id').val(user_id);
    $('#action').val("Editar Jerarquia");
    $('#operation').val("Editar Jerarquia");
   }
  })
 });
      ...
      <div class="modal-dialog wd-xl-400" role="document">
        <div class="modal-content ">
          ...
          <div class="modal-body pd-20 pd-sm-40">
            ...
            <form class="parsley-style-1"  method="post" id='jerarquia_form'>
               <h5 class="modal-title mg-b-5">Cargos</h5>
        
             <div class="form-group">
              <input type="text" class="form-control" placeholder="Detalle de la Jerarquía" id="detalleJerarquia" name="detalleJerarquia" required="">
            </div><!-- form-group -->
