...
<html lang="en">
  <head>
    ...
    <title>Administrador - Sistema de Evaluación 360</title>
    ...
    <link href="../template/template/lib/flag-icon-css/css/flag-icon.min.css" rel="stylesheet">
  ...
  <body class="az-dashboard">
      ...
      <div class="container">
        ...
        <ul class="nav">
          ...
          <li class="nav-item active show">
            <a href="index.html" class="nav-link with-sub"><i class="typcn typcn-clipboard"></i>Parametrización</a>
            <nav class="nav-sub">
   ...
   <div id="capa"></div>
    ...
    <div class="az-footer">
      <div class="container">
        <span>Unidad Educativa Cristo Rey </span>
        <span></span>
      </div><!-- container -->
    </div><!-- az-footer -->
    ...
    <script src="../template/template/lib/jquery.flot/jquery.flot.js"></script>
    <script src="../template/template/lib/jquery.flot/jquery.flot.resize.js"></script>
    <script src="../template/template/lib/chart.js/Chart.bundle.min.js"></script>
    <script src="../template/template/lib/peity/jquery.peity.min.js"></script>

    <script src="../template/template/js/azia.js"></script>
    <script src="../template/template/js/chart.flot.sampledata.js"></script>
    <script src="../template/template/js/dashboard.sampledata.js"></script>
    <script>
      $(function(){
