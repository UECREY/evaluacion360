    ...
    <div class="az-content">
      <div class="container">
        <div class="az-content-body">
          ...
          <div class="az-content-label mg-b-5">Opciones de Respuestas</div>
          <p class="mg-b-20">Opciones Ingresadas</p>
...
var dataTable = $('#datatable1').DataTable({
  ...
  "bDeferRender": true,     
      ...
      "order":[],
    "ajax": {
    "url": "lib/server/fetchOpciones.php",
    "type": "POST"
    },          
...
$('#add_button').click(function(){
  $('#opciones_form')[0].reset();
  $('.modal-title').text("Opciones");
  $('#action').val("Guardar Opciones");
  $('#operation').val("Guardar Opciones");
  $('#user_uploaded_image').html('');
  //$('.selectpicker').selectpicker();
 
 });
 $(document).on('submit', '#opciones_form', function(event){
  event.preventDefault();

  var detalleOpcionesRes= $('#detalleOpcionesRes').val();
  
    if(detalleOpcionesRes!= '')
  {
   $.ajax({
    url:"lib/server/insert.php",
    method:'POST',
 ...
 //  alert("Ingresa");
  $.ajax({
   url:"lib/server/fetchOpcionesSingle.php",
   method:"POST",
   ...
   success:function(data)
   {
    ...
    $('#detalleOpcionesRes').val(data.detalleOpcionesRes);
 ...
 //   $('#mailInscripcion_alu').val(data.mailInscripcion_alu);
  //  $('#codigoIdentificacion_alu').val(data.codigoIdentificacion_alu);
   ...
   // $('#documentaciona_alu option[value='+data.documentaciona_alu+']').attr("selected",true);
    ...
    $('.modal-title').text("Editar Opciones");
    $('#user_id').val(user_id);
    $('#action').val("Editar Opciones");
    $('#operation').val("Editar Opciones");
   }
  })
 });
      ...
      <div class="modal-dialog wd-xl-400" role="document">
        <div class="modal-content ">
          ...
          <div class="modal-body pd-20 pd-sm-40">
            ...
            <form class="parsley-style-1"  method="post" id='opciones_form'>
               <h5 class="modal-title mg-b-5">Cargos</h5>
        
             <div class="form-group">
              <input type="text" class="form-control" placeholder="Detalle de la Opción" id="detalleOpcionesRes" name="detalleOpcionesRes" required="">
            </div><!-- form-group -->
